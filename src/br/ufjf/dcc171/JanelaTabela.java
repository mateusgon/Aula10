...
public class JanelaTabela extends JFrame{
    ...
    private JTextField txtIdade = new JTextField(3);
    ...
    public JanelaTabela() throws HeadlessException {
        super("Janela Tabela");
        Object [][]dados = new Object[][]{{"Fulano", "18", "fulano@somedomain.com"},
        {"Fulano", "18", "fulano@somedomain.com"}, {"Fulano", "18", "fulano@somedomain.com"}};
        ...
        btnAdicionar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                DefaultTableModel modelo = (DefaultTableModel)tabela.getModel();
                modelo.addRow (new Object[]{txtNome.getText(), txtIdade.getText(), txtEmail.getText()});
                txtNome.setText("");
                txtIdade.setText("");
                txtEmail.setText("");
